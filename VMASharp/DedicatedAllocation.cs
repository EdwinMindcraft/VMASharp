    ...
    internal class DedicatedAllocation : Allocation {
        ...
        internal unsafe Result DedicatedAllocMap(out IntPtr pData) {
            if (this.mapCount != 0) {
                ...
                IntPtr tmp;
                Result res = this.VkApi.MapMemory(this.Allocator.Device, this.memory, 0, Vk.WholeSize, 0, (void**)&tmp);
        ...
        internal void DedicatedAllocUnmap() {
            if ((this.mapCount & int.MaxValue) != 0) {
                ...
                if (this.mapCount == 0) {
                    ...
                    this.VkApi.UnmapMemory(this.Allocator.Device, this.memory);
                }
            } else {
        ...
        public override IntPtr Map() {
            Result res = this.DedicatedAllocMap(out IntPtr pData);
