...
internal sealed class GenericDefragAlgorithm : DefragmentationAlgorithm {
    ...
    private class BlockInfo {
        ...
        public void SortAllocationsBySizeDescending() {
            this.Allocations.Sort(delegate(AllocateInfo info1, AllocateInfo info2) { return info1.Allocation.Size.CompareTo(info2.Allocation.Size); });
        }

        public void SortAllocationsByOffsetDescending() {
            this.Allocations.Sort(delegate(AllocateInfo info1, AllocateInfo info2) { return info1.Allocation.Offset.CompareTo(info2.Allocation.Offset); });
        }
    }
    ...
    private int CalcBlocksWithNonMovableCount() => throw new NotImplementedException();
